...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const getRedBalance = () => {
      try {
        const val =
          localStorage.getItem('arena_red_diamonds') ||
  ...
  const handleLogout = async () => {
    try {
      ...
      // Clear only temporary/local wallet display values.
      // Supabase account data is NOT deleted.
      localStorage.removeItem('arena_red_diamonds');
      localStorage.removeItem('arena_red_dias');
      localStorage.removeItem('arena_diamond');
      localStorage.removeItem('arena_cash');
  ...
  const handleClaimDaily = () => {
    ...
    const currentWhite =
      localStorage.getItem('arena_white_diamonds');

    const newWhiteBal =
      (currentWhite
        ? parseInt(currentWhite, 10)
        : 24500) + 1000;

    localStorage.setItem(
      'arena_white_diamonds',
      newWhiteBal.toString()
    );
    ...
    alert(
      currentLang === 'ne'
        ? '🎁 दैनिक बोनस प्राप्त भयो! +1000 सेतो हिरा थपियो!'
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center pb-24 select-none relative">
          ...
          {session ? (
            <>
              ...
              <button
                ...
                className="text-[10px] font-black bg-red-600/20 text-red-400 border border-red-500/50 px-2.5 py-1.5 rounded-xl shadow-lg hover:bg-red-600 hover:text-white hover:scale-105 transition-all cursor-pointer"
                title="Logout"
              >
                Logout
              </button>
      ...
      <div className="w-full max-w-md flex flex-col items-center flex-1 p-4 gap-4">
        ...
        {activeTab === 'home' && (
          <>
            ...
            {selectedGame === 'spin' ? (
              /* ✅ MAIN ARENA SPINNER WINNER — UNTOUCHED */
              <ArenaSpinnerWinner />
              ...
              <div className="w-full flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="text-xs font-black text-white uppercase tracking-wider flex items-center gap-1.5">
                        ...
                        {t.dailyMissionTitle || "Your Daily Mission"}

                        <span className="text-[9px] bg-yellow-400 text-black px-1.5 py-0.5 rounded-full font-extrabold">
                          NEW
                        </span>
                      ...
                      <p className="text-[10px] text-gray-300 mt-0.5">
                        {t.dailyMissionDesc || "Complete tasks & refer friends for rewards!"}
                      </p>
                ...
                <div className="w-full bg-gradient-to-r from-indigo-950 via-purple-950 to-gray-900 border border-purple-500/40 p-4 rounded-3xl shadow-2xl relative overflow-hidden flex flex-col justify-between">
                  ...
                  <div className="absolute right-12 top-2 text-3xl opacity-20">
                    🏆
                  </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] font-bold text-white">
                          {t.dailyLoginBonus || "Daily Login Bonus"}
                        </p>

                        <p className="text-[9px] text-cyan-400 font-semibold">
                          {t.freeDiamonds || "+1000 White Diamonds Free"}
                        </p>
                ...
                <div className="flex items-center justify-between px-1">
                  ...
                  <h3 className="text-xs font-black text-gray-300 uppercase tracking-wider flex items-center gap-1.5">
                    <span>⚡</span>
                    {t.specialArcade || "Featured Arcade Games"}
                  </h3>

                  <span className="text-[10px] text-cyan-400 font-bold">
                    8 {t.availableGames || "Games Available"}
                  </span>
                ...
                <div className="grid grid-cols-2 gap-3.5 w-full">
                  ...
                  {GAMES_LIST.map((game) => (
                    ...
                    >
                      ...
                      {/* Thumbnail Container */}
                      <div
                        className={`relative w-full h-28 rounded-2xl overflow-hidden border ${game.border} shadow-xl bg-gray-900 group-hover:scale-[1.03] transition-all`}
                      >
      ...
      {/* ❌ FLOATING LUCKY SPIN WIDGET REMOVED */}
